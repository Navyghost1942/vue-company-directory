<script setup>
import { ref } from 'vue'
import { useAuth } from '@/comosables/userAuth'
  ...
  <nav>
    <div class="wrapper">
      ...
      <div class="menu">
        ...
        <button class="menu-login" @click="logout">Logout</button>
        </div>
        <div v-else>
        <RouterLink :to="{ name: 'Home'}" href="#" class="menu-item">Login</RouterLink>
        </div>
      </div>
    </div>
  </nav>
